...
private let html4encode: [Character: String] = [
    ...
    "\u{02DC}" : "&tilde;",
    "\u{2002}" : "&ensp;",
    // "\u{2003}" : "&emsp;", // duplicate with \u{2002} on Linux toolchain
    // "\u{2009}" : "&thinsp;", // duplicate with \u{2002} on Linux toolchain
    // "\u{200C}" : "&zwnj;", // duplicate with \u{00AD} on Linux toolchain
    // "\u{200D}" : "&zwj;", // duplicate with \u{00AD} on Linux toolchain
    // "\u{200E}" : "&lrm;", // duplicate with \u{00AD} on Linux toolchain
    // "\u{200F}" : "&rlm;", // duplicate with \u{00AD} on Linux toolchain
    "\u{2013}" : "&ndash;",
    "\u{2014}" : "&mdash;",
    "\u{2018}" : "&lsquo;",
    "\u{2019}" : "&rsquo;",
