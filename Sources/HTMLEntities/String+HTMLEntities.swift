...
private let html4encode: [Character: String] = [
    ...
    "\u{00A0}":"&nbsp;","\u{00A1}":"&iexcl;","\u{00A2}":"&cent;","\u{00A3}":"&pound;",
    "\u{00A4}":"&curren;","\u{00A5}":"&yen;","\u{00A6}":"&brvbar;","\u{00A7}":"&sect;",
    "\u{00A8}":"&uml;","\u{00A9}":"&copy;","\u{00AA}":"&ordf;","\u{00AB}":"&laquo;",
    "\u{00AC}":"&not;","\u{00AD}":"&shy;","\u{00AE}":"&reg;","\u{00AF}":"&macr;",
    "\u{00B0}":"&deg;","\u{00B1}":"&plusmn;","\u{00B2}":"&sup2;","\u{00B3}":"&sup3;",
    "\u{00B4}":"&acute;","\u{00B5}":"&micro;","\u{00B6}":"&para;","\u{00B7}":"&middot;",
    "\u{00B8}":"&cedil;","\u{00B9}":"&sup1;","\u{00BA}":"&ordm;","\u{00BB}":"&raquo;",
    "\u{00BC}":"&frac14;","\u{00BD}":"&frac12;","\u{00BE}":"&frac34;","\u{00BF}":"&iquest;",
    "\u{00C0}":"&Agrave;","\u{00C1}":"&Aacute;","\u{00C2}":"&Acirc;","\u{00C3}":"&Atilde;",
    "\u{00C4}":"&Auml;","\u{00C5}":"&Aring;","\u{00C6}":"&AElig;","\u{00C7}":"&Ccedil;",
    "\u{00C8}":"&Egrave;","\u{00C9}":"&Eacute;","\u{00CA}":"&Ecirc;","\u{00CB}":"&Euml;",
    "\u{00CC}":"&Igrave;","\u{00CD}":"&Iacute;","\u{00CE}":"&Icirc;","\u{00CF}":"&Iuml;",
    "\u{00D0}":"&ETH;","\u{00D1}":"&Ntilde;","\u{00D2}":"&Ograve;","\u{00D3}":"&Oacute;",
    "\u{00D4}":"&Ocirc;","\u{00D5}":"&Otilde;","\u{00D6}":"&Ouml;","\u{00D7}":"&times;",
    "\u{00D8}":"&Oslash;","\u{00D9}":"&Ugrave;","\u{00DA}":"&Uacute;","\u{00DB}":"&Ucirc;",
    "\u{00DC}":"&Uuml;","\u{00DD}":"&Yacute;","\u{00DE}":"&THORN;","\u{00DF}":"&szlig;",
    "\u{00E0}":"&agrave;","\u{00E1}":"&aacute;","\u{00E2}":"&acirc;","\u{00E3}":"&atilde;",
    "\u{00E4}":"&auml;","\u{00E5}":"&aring;","\u{00E6}":"&aelig;","\u{00E7}":"&ccedil;",
    "\u{00E8}":"&egrave;","\u{00E9}":"&eacute;","\u{00EA}":"&ecirc;","\u{00EB}":"&euml;",
    "\u{00EC}":"&igrave;","\u{00ED}":"&iacute;","\u{00EE}":"&icirc;","\u{00EF}":"&iuml;",
    "\u{00F0}":"&eth;","\u{00F1}":"&ntilde;","\u{00F2}":"&ograve;","\u{00F3}":"&oacute;",
    "\u{00F4}":"&ocirc;","\u{00F5}":"&otilde;","\u{00F6}":"&ouml;","\u{00F7}":"&divide;",
    "\u{00F8}":"&oslash;","\u{00F9}":"&ugrave;","\u{00FA}":"&uacute;","\u{00FB}":"&ucirc;",
    "\u{00FC}":"&uuml;","\u{00FD}":"&yacute;","\u{00FE}":"&thorn;","\u{00FF}":"&yuml;",

    // Symbols, mathematical symbols, and Greek letters
    // https://www.w3.org/TR/html4/sgml/entities.html#h-24.3.1
    "\u{0192}":"&fnof;","\u{0391}":"&Alpha;","\u{0392}":"&Beta;","\u{0393}":"&Gamma;",
    "\u{0394}":"&Delta;","\u{0395}":"&Epsilon;","\u{0396}":"&Zeta;","\u{0397}":"&Eta;",
    "\u{0398}":"&Theta;","\u{0399}":"&Iota;","\u{039A}":"&Kappa;","\u{039B}":"&Lambda;",
    "\u{039C}":"&Mu;","\u{039D}":"&Nu;","\u{039E}":"&Xi;","\u{039F}":"&Omicron;",
    "\u{03A0}":"&Pi;","\u{03A1}":"&Rho;","\u{03A3}":"&Sigma;","\u{03A4}":"&Tau;",
    "\u{03A5}":"&Upsilon;","\u{03A6}":"&Phi;","\u{03A7}":"&Chi;","\u{03A8}":"&Psi;",
    "\u{03A9}":"&Omega;","\u{03B1}":"&alpha;","\u{03B2}":"&beta;","\u{03B3}":"&gamma;",
    "\u{03B4}":"&delta;","\u{03B5}":"&epsilon;","\u{03B6}":"&zeta;","\u{03B7}":"&eta;",
    "\u{03B8}":"&theta;","\u{03B9}":"&iota;","\u{03BA}":"&kappa;","\u{03BB}":"&lambda;",
    "\u{03BC}":"&mu;","\u{03BD}":"&nu;","\u{03BE}":"&xi;","\u{03BF}":"&omicron;",
    "\u{03C0}":"&pi;","\u{03C1}":"&rho;","\u{03C2}":"&sigmaf;","\u{03C3}":"&sigma;",
    "\u{03C4}":"&tau;","\u{03C5}":"&upsilon;","\u{03C6}":"&phi;","\u{03C7}":"&chi;",
    "\u{03C8}":"&psi;","\u{03C9}":"&omega;","\u{03D1}":"&thetasym;","\u{03D2}":"&upsih;",
    "\u{03D6}":"&piv;","\u{2022}":"&bull;","\u{2026}":"&hellip;","\u{2032}":"&prime;",
    "\u{2033}":"&Prime;","\u{203E}":"&oline;","\u{2044}":"&frasl;","\u{2118}":"&weierp;",
    "\u{2111}":"&image;","\u{211C}":"&real;","\u{2122}":"&trade;","\u{2135}":"&alefsym;",
    "\u{2190}":"&larr;","\u{2191}":"&uarr;","\u{2192}":"&rarr;","\u{2193}":"&darr;",
    "\u{2194}":"&harr;","\u{21B5}":"&crarr;","\u{21D0}":"&lArr;","\u{21D1}":"&uArr;",
    "\u{21D2}":"&rArr;","\u{21D3}":"&dArr;","\u{21D4}":"&hArr;","\u{2200}":"&forall;",
    "\u{2202}":"&part;","\u{2203}":"&exist;","\u{2205}":"&empty;","\u{2207}":"&nabla;",
    "\u{2208}":"&isin;","\u{2209}":"&notin;","\u{220B}":"&ni;","\u{220F}":"&prod;",
    "\u{2211}":"&sum;","\u{2212}":"&minus;","\u{2217}":"&lowast;","\u{221A}":"&radic;",
    "\u{221D}":"&prop;","\u{221E}":"&infin;","\u{2220}":"&ang;","\u{2227}":"&and;",
    "\u{2228}":"&or;","\u{2229}":"&cap;","\u{222A}":"&cup;","\u{222B}":"&int;",
    "\u{2234}":"&there4;","\u{223C}":"&sim;","\u{2245}":"&cong;","\u{2248}":"&asymp;",
    "\u{2260}":"&ne;","\u{2261}":"&equiv;","\u{2264}":"&le;","\u{2265}":"&ge;",
    "\u{2282}":"&sub;","\u{2283}":"&sup;","\u{2284}":"&nsub;","\u{2286}":"&sube;",
    "\u{2287}":"&supe;","\u{2295}":"&oplus;","\u{2297}":"&otimes;","\u{22A5}":"&perp;",
    "\u{22C5}":"&sdot;","\u{2308}":"&lceil;","\u{2309}":"&rceil;","\u{230A}":"&lfloor;",
    "\u{230B}":"&rfloor;","\u{2329}":"&lang;","\u{232A}":"&rang;","\u{25CA}":"&loz;",
    "\u{2660}":"&spades;","\u{2663}":"&clubs;","\u{2665}":"&hearts;","\u{2666}":"&diams;",

    // Markup-significant and internationalization characters
    // https://www.w3.org/TR/html4/sgml/entities.html#h-24.4.1
    "\u{0022}":"&quot;","\u{0026}":"&amp;","\u{003C}":"&lt;","\u{003E}":"&gt;",
    "\u{0152}":"&OElig;","\u{0153}":"&oelig;","\u{0160}":"&Scaron;","\u{0161}":"&scaron;",
    "\u{0178}":"&Yuml;","\u{02C6}":"&circ;","\u{02DC}":"&tilde;","\u{2002}":"&ensp;",

    // duplicate with \u{2002} on Linux toolchain
    // "\u{2003}":"&emsp;","\u{2009}":"&thinsp;",

    // duplicate with \u{00AD} on Linux toolchain
    // "\u{200C}":"&zwnj;","\u{200D}":"&zwj;","\u{200E}":"&lrm;","\u{200F}":"&rlm;",

    "\u{2013}":"&ndash;","\u{2014}":"&mdash;","\u{2018}":"&lsquo;","\u{2019}":"&rsquo;",
    "\u{201A}":"&sbquo;","\u{201C}":"&ldquo;","\u{201D}":"&rdquo;","\u{201E}":"&bdquo;",
    "\u{2020}":"&dagger;","\u{2021}":"&Dagger;","\u{2030}":"&permil;","\u{2039}":"&lsaquo;",
    "\u{203A}":"&rsaquo;","\u{20AC}":"&euro;"
]
#else
private let html4encode: [Character: String] = [
    // ISO 8859-1 characters
    ...
    "\u{0152}":"&OElig;","\u{0153}":"&oelig;","\u{0160}":"&Scaron;","\u{0161}":"&scaron;",
    "\u{0178}":"&Yuml;","\u{02C6}":"&circ;","\u{02DC}":"&tilde;","\u{2002}":"&ensp;",
    "\u{2003}":"&emsp;","\u{2009}":"&thinsp;","\u{200C}":"&zwnj;","\u{200D}":"&zwj;",
    "\u{200E}":"&lrm;","\u{200F}":"&rlm;","\u{2013}":"&ndash;","\u{2014}":"&mdash;",
    "\u{2018}":"&lsquo;","\u{2019}":"&rsquo;","\u{201A}":"&sbquo;","\u{201C}":"&ldquo;",
    "\u{201D}":"&rdquo;","\u{201E}":"&bdquo;","\u{2020}":"&dagger;","\u{2021}":"&Dagger;",
    "\u{2030}":"&permil;","\u{2039}":"&lsaquo;","\u{203A}":"&rsaquo;","\u{20AC}":"&euro;"
]
#endif
...
private let html4decode: [String: Character] = [
    ...
    // Symbols, mathematical symbols, and Greek letters
    // https://www.w3.org/TR/html4/sgml/entities.html#h-24.3.1
    "&fnof;":"\u{0192}","&Alpha;":"\u{0391}","&Beta;":"\u{0392}","&Gamma;":"\u{0393}",
    ...
    "&psi;":"\u{03C8}","&omega;":"\u{03C9}","&thetasym;":"\u{03D1}","&upsih;":"\u{03D2}",
    "&piv;":"\u{03D6}","&bull;":"\u{2022}","&hellip;":"\u{2026}","&prime;":"\u{2032}",
    "&Prime;":"\u{2033}","&oline;":"\u{203E}","&frasl;":"\u{2044}","&weierp;":"\u{2118}",
    "&image;":"\u{2111}","&real;":"\u{211C}","&trade;":"\u{2122}","&alefsym;":"\u{2135}",
    ...
    "&Yuml;":"\u{0178}","&circ;":"\u{02C6}","&tilde;":"\u{02DC}","&ensp;":"\u{2002}",
    "&emsp;":"\u{2003}","&thinsp;":"\u{2009}","&zwnj;":"\u{200C}","&zwj;":"\u{200D}",
    "&lrm;":"\u{200E}","&rlm;":"\u{200F}","&ndash;":"\u{2013}","&mdash;":"\u{2014}",
    "&lsquo;":"\u{2018}","&rsquo;":"\u{2019}","&sbquo;":"\u{201A}","&ldquo;":"\u{201C}",
    "&rdquo;":"\u{201D}","&bdquo;":"\u{201E}","&dagger;":"\u{2020}","&Dagger;":"\u{2021}",
    "&permil;":"\u{2030}","&lsaquo;":"\u{2039}","&rsaquo;":"\u{203A}","&euro;":"\u{20AC}"
]

// constants used to avoid character initializations in loop
private let ampersand: Character = "&"
...
public extension String {
    /// Return string as HTML encoded by replacing certain characters with their
    ...
    /// Return string as HTML decoded by replacing HTML named character entities
